...
The activity plugin shows the latest activity from your repositories.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-activity-plugin/docs).
